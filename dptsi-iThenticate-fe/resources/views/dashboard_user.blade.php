    ...
    <div class="bootstrap_datatables">
        ...
        <div class="row py-5">
            ...
            <div class="card rounded shadow border-0">
                ...
                <h3 style="font-weight: bold">0/2 Submission Limit</h3><br>
                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <td>Wednesday, 17 Dec 2022 10:42 PM</td>
                        <td style="color: red">Waiting</td>
                        </tr>
                        
                        <tr>
                            <td><button class="btn btn-primary" data-toggle="modal" data-target="#myModal" style="border:none;width: fit-content;height: fit-content;background-color:#013880;text-align:center;" type="button">Details</button></td>
                            <td></td>
                            <td style="color: grey">Wednesday, 17 Dec 2022 10:42 PM</td>
                            <td style="color: grey">Finished</td>
                        </tr>
                    </tbody>
                    </table>
                </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                ...
                <h4 style="color:#013880;"><span class="glyphicon glyphicon-lock"></span> User Details</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <h6 style="font-size:16px;color:#FF0000" aria-placeholder="SSO_ID">60% Similarity index</h6>
                    <h6 style="font-size:16px;" aria-placeholder="SSO_ID">0% Internet Resources</h6>
                    <h6 style="font-size:16px;color:#FF0000" aria-placeholder="SSO_ID">20% Publications</h6>
                    <h6 style="font-size:16px;" aria-placeholder="SSO_ID">1% Student Papers</h6>
                </div>
        ...
        {{-- Example Modal for Finished Submission --}}
